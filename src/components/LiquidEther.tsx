  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      init(container: HTMLElement) {
        ...
        this.pixelRatio = 1; // Opt for better performance
        this.resize();
...
`;
  ...
  return (
    <div
      ref={mountRef}
      className={`w-full h-full relative overflow-hidden pointer-events-none md:pointer-events-auto touch-auto md:touch-none ${
        className || ""
      }`}
      style={style}
    />
